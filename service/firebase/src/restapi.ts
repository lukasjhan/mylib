...
import { DeleteUserRes, RefreshTokenRes, ResetPasswordRes, SignInRes, SignUpRes, UpdatePasswordRes } from "./type/firebase";
...
export const refreshTokenToFirebaseAuth = async (
  ...
  const response = await axios<RefreshTokenRes>(
...
export const resetPasswordToFirebaseAuth = async (
  ...
  const response = await axios<ResetPasswordRes>(
...
export const updatePasswordToFirebaseAuth = async (
  ...
  const response = await axios<UpdatePasswordRes>(
    updatePassword,
    {
      method: 'POST',
      headers: {
...
export const signUpToFirebaseAuth = async (
  ...
  const response = await axios<SignUpRes>(
    signUpEndPoint,
    {
      method: 'POST',
      headers: {
...
export const deleteUserFromFirebaseAuth = async (idToken: string): Promise<DeleteUserRes> => {
  const signUpEndPoint = `${FIREBASE_ENDPOINT.DELETE}?key=${config.apikey}`;

  const response = await axios<DeleteUserRes>(
    signUpEndPoint,
    {
      method: 'POST',
      headers: {
